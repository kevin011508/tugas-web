        ...
        <div class="container px-4 px-lg-5 mt-5">
                        ...
                        <div class="card h-100">
                          <h2>minuman</h2>
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="detail2.php?id=<?= $produk['id'] ?>">DETAIL</a></div>
                            </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container px-4 px-lg-5 mt-5">
                <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                    ...
                    $tambah = mysqli_query($koneksi, "SELECT * from produk WHERE kategori='makanan'");
                    while ($produk = mysqli_fetch_array($tambah)) {
                    ?>
                    <div class="col mb-5">
                        <div class="card h-100">
