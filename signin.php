<?php
include 'koneksi.php';
$koneksi = mysqli_connect("localhost", "root", "", "caffe_nova");
...
<main class="form-signin w-100 m-auto">
  <form action="" method="post">
    <img class="mb-4" src="./img/coffe.jpg.jpg" alt="" width="72" height="57">
    <h1 class="h3 mb-3 fw-normal">Please sign in</h1>
    <div class="form-floating">
      <input type="" class="form-control" id="floatingInput" placeholder="name@example.com">
      <label for="floatingInput"name="username">User Name</label>
    </div>
    <div class="form-floating">
